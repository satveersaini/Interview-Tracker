...
// database connection
const dbURI = "mongodb+srv://sainisatveer676:KuWA5Ze0PUc3Wvqc@cluster0.rvs5olo.mongodb.net/";
...
app.get('/topics', requireAuth, (req, res) => Topic.find({}).then(
    function(result){ 
      //console.log(result);
      result=[{name:"alltopics"},{name:"arrays"},{name:"binary search"},{name:"dynamic programming"},{name:"graphs"},{name:"stacks and queues"},{name:"timecomplex"}]
